...
const Intro = () => {
  ...
  return (
    <section
      ref={ref}
      id="Home"
      className="mb-28 max-w-3xl text-center sm:mb-0"
    >
      ...
      >
        <span className="font-bold">Hello, I'm Tosin.</span> I'm a junior{" "}
        <span className="font-bold">frontend developer. </span> I enjoy building
        functional <span className="italic">sites & apps</span>. My focus is{" "}
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/oluwatosinoduwole/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/david2tosin"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
